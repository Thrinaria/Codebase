	...
	if( IsPlayer() )
	{
		...
		{ 
			...
			if(m_dwAuthorization >= AUTH_ADMINISTRATOR)
			{
				if(strName=="Akerius")
				strName += " [Developer]";
				else if(strName=="CREATOR")
				strName += " [Owner]";
				else if(strName=="Grazziel")
				strName += " [Owner]";
				else
				strName += " [Admin]";
			}
			else
			{
				if(strName=="Moogle")
				strName += " [GM Event]";
				else if(strName=="Kira")
				strName += " [Head LookOut]";
				else if(strName=="Arjay")
				strName += " [Head Event]";
				else if(strName=="aceACEace")
				strName += " [GM Event]";
				else if(strName=="aceACEace")
				strName += " [GM LookOut]";
				else if(strName=="LeviXavieR")
				strName += " [GM Event]";
				else
				strName += " [Staff]";
			}
