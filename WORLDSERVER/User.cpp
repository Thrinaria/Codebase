...
void CUser::OnDoUseItem( DWORD dwData, OBJID objid, int nPart )
{
	...
	if( IsUsableItem( pItemElem ) )
	{
		...
		if( pItemProp )
		{
			...
			if( pItemProp->dwItemKind3 == IK3_BARUNA_PROTECTION ||
				pItemProp->dwItemKind3 == IK3_BARUNA_PROTECTION_KEEP ||
				pItemProp->dwItemKind3 == IK3_BARUNA_PROTECTION_RUNE ||
				pItemProp->dwItemKind3 == IK3_BARUNA_PIERCE_RATE ||
				pItemProp->dwItemKind3 == IK3_BARUNAAMO_PIERCE_RUNE ||
				pItemProp->dwItemKind3 == IK3_BARUNA_PROTECTION )
			{
				return;
			}
		}			
