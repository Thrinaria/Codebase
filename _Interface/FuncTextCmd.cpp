...
{ 
#ifdef __WORLDSERVER
    g_DPCoreClient.SendSystem( "Disconnected" );
...
if(pUser->m_nLevel >= 175 && pUser->IsLegendHero())
{
...
#ifdef __REBIRTH
	ON_TEXTCMDFUNC( TextCmd_rebirth,              "rebirth",          "rebirth",             "텔레포트",       "텔레",    TCM_SERVER, AUTH_GENERAL   , "텔레포트" )
#endif	
