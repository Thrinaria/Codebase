...
//	AfxMessageBox(temp, MB_OK);
	...
	lstrcpy( g_Neuz.m_lpCertifierAddr, "31.151.61.49" ); // Local Test
	//lstrcpy( g_Neuz.m_lpCertifierAddr, "119.93.101.25" ); // Online Test
