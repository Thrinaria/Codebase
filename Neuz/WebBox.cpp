...
//	wsprintf( address, WEB_ADDRESS_DEFAULT );
	...
	if( ::GetLanguage() == LANG_JAP || ::GetLanguage() == LANG_THA || ::GetLanguage() == LANG_ENG || GetLanguage() == LANG_TWN || ::GetLanguage() == LANG_GER || ::GetLanguage() == LANG_SPA || ::GetLanguage() == LANG_FRE || GetLanguage() == LANG_HK || ::GetLanguage() == LANG_POR || ::GetLanguage() == LANG_VTN || ::GetLanguage() == LANG_RUS || ::GetLanguage() == LANG_PHP || ::GetLanguage() == LANG_ID )
	{
		char out[260]	= { 0, };
		char in[260]	= { 0, };
		...
		if( ::GetLanguage() == LANG_ENG || ::GetLanguage() == LANG_SPA || ::GetLanguage() == LANG_THA ||::GetLanguage() == LANG_HK || ::GetLanguage() == LANG_POR || ::GetLanguage() == LANG_VTN || ::GetLanguage() == LANG_RUS || ::GetLanguage() == LANG_ID || ::GetLanguage() == LANG_PHP )
		{
...
//		wsprintf( address, WEB_ADDRESS_DEFAULT );
		wsprintf( address, GetAddress() );
		if( ::GetLanguage() == LANG_ID || ::GetLanguage() == LANG_PHP || ::GetLanguage() == LANG_JAP || ::GetLanguage() == LANG_THA || ::GetLanguage() == LANG_ENG || GetLanguage() == LANG_TWN || ::GetLanguage() == LANG_GER || ::GetLanguage() == LANG_SPA || ::GetLanguage() == LANG_FRE || GetLanguage() == LANG_HK || ::GetLanguage() == LANG_POR || ::GetLanguage() == LANG_VTN || ::GetLanguage() == LANG_RUS )
		{
			char out[260]	= { 0, };
			char in[260]	= { 0, };
			if( ::GetLanguage() == LANG_JAP || ::GetLanguage() == LANG_THA )
			...
			if( ::GetLanguage() == LANG_ENG || ::GetLanguage() == LANG_SPA || ::GetLanguage() == LANG_THA || ::GetLanguage() == LANG_HK || ::GetLanguage() == LANG_POR || ::GetLanguage() == LANG_VTN || ::GetLanguage() == LANG_RUS || ::GetLanguage() == LANG_PHP || ::GetLanguage() == LANG_ID )
			{
				wsprintf( postdata, WEB_POSTDATA, m_szUser, m_nPlayer, m_nServer, out, g_Neuz.m_szPassword );
			}
			else if( ::GetLanguage() == LANG_GER || ::GetLanguage() == LANG_FRE )
